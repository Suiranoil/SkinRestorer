...
public final class SkinService {
    ...
    public static Collection<ServerPlayer> applySkin(
            MinecraftServer server, Iterable<ServerPlayer> targets, SkinValue value, boolean save) {
        ...
        for (var player : targets) {
            ...
            if (save) SkinRestorer.getSkinStorage().setSkin(profile.id(), playerValue);
    ...
    public static Collection<ServerPlayer> applySkin(
            MinecraftServer server, Iterable<ServerPlayer> targets, SkinValue value) {
