...
public final class CustomProviderListDeserializer
        implements JsonSerializer<List<CustomProviderConfig>>, JsonDeserializer<List<CustomProviderConfig>> {
    @Override
        ...
        for (var element : json.getAsJsonArray()) {
            ...
            CustomProviderConfig provider =
                    switch (providerType) {
                        ...
                        case USERNAME_URL -> context.deserialize(object, CustomUsernameUrlProviderConfig.class);
